...
"use strict";module.exports={schema:{takeOwnership:{default:!1}},networkedInit:function(){this.isNetworked=window.NAF&&!!window.NAF.utils.getNetworkedEntity(this.el)},networkedOk:function(){return!this.isNetworked||window.NAF.utils.isMine(this.el)||!!this.data.takeOwnership&&window.NAF.utils.takeOwnership(this.el)}};
